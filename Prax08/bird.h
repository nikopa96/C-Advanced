...
class FlyingBird : public virtual Bird {
public:
...
class SwimmingBird : public virtual Bird {
public:
...
public:
    Pidgeon()
        : FlyingBird("pidgeon",counter),
          Bird("pidgeon",++counter) {}
private:
...
public:
    Penguin()
        : SwimmingBird("penguin",counter),
          Bird("penguin",++counter){}
private:
    static size_t counter;
};
...
class FlyingSwimmingBird : public FlyingBird, public SwimmingBird {
public:
    FlyingSwimmingBird(const std::string &birdName, size_t birdId)
        : FlyingBird(birdName,birdId),
          SwimmingBird(birdName,birdId),
          Bird(birdName,birdId) {}
    void doEverything() override;
};

class Duck : public FlyingSwimmingBird {
public:
    Duck()
        : FlyingSwimmingBird("duck",counter),
          Bird("duck",++counter) {}
private:
    static size_t counter;
};
